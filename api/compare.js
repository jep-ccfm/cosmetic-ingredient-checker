...
- 두 자료의 언어가 다를 수 있습니다(예: 문안=한국어, 디자인=대만 번체 중국어/영어). 언어가 다르면
  "의미가 서로 대응되는지"로 비교하세요. 성분·숫자·용량·중량·필수 문구가 문안 기준과 일치하는지 확인하고,
  번역이 누락됐으면 "미기재", 잘못 번역/표기됐으면 "오기재"로 분류하세요. 성분명·브랜드명·숫자처럼
  언어와 무관하게 동일해야 하는 항목은 철자까지 대조하세요. (detail에 어떤 언어인지도 간단히 적어주세요.)
